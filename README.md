...
이 프로젝트는 Spring Boot를 기반으로 한 온라인 쇼핑몰 백엔드 애플리케이션입니다. RESTful API를 제공하며, 제품 관리, 주문 처리, 장바구니 관리, 사용자 인증 및 결제 처리 기능을 포함하고 있습니다. 이 서비스는 JWT를 사용한 인증, BCrypt를 이용한 비밀번호 암호화, KakaoPay와의 결제 통합 등을 통해 확장성과 보안을 고려하여 설계되었습니다.
